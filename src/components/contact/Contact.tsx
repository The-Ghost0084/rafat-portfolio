      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-slate-600 sm:text-lg">
            For project collaboration, technical support, geospatial solutions,
            or professional opportunities, feel free to get in touch.
          </p>
        </div>
        ...
        <div className="mx-auto mt-16 max-w-5xl border-t border-slate-200 pt-8 text-center">
          <p className="text-sm text-slate-500">
            Rafat Mohammed · Technical Support &amp; Projects Team Leader ·
